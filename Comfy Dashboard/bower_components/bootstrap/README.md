# [Bootstrap](https://getbootstrap.com) [![Bower version](https://badge.fury.io/bo/bootstrap.png)](https://badge.fury.io/bo/bootstrap) [![Build Status](https://secure.travis-ci.org/twbs/bootstrap.png)](https://travis-ci.org/twbs/bootstrap) [![devDependency Status](https://david-dm.org/twbs/bootstrap/dev-status.png?theme=shields.io)](https://david-dm.org/twbs/bootstrap#info=devDependencies)
...
2. From the root `/bootstrap` directory, run `jekyll serve` in the command line.
  - **Windows users:** While we use Jekyll's `encoding` setting, you might still need to change the command prompt's character encoding ([code page](https://en.wikipedia.org/wiki/Windows_code_page)) to UTF-8 so Jekyll runs without errors. For Ruby 2.0.0, run `chcp 65001` first. For Ruby 1.9.3, you can alternatively do `SET LANG=en_EN.UTF-8`.
...
#### Build - `grunt`
Run `grunt` to run tests locally and compile the CSS and JavaScript into `/dist`. **Uses [Less](https://lesscss.org/) and [UglifyJS](https://lisperator.net/uglifyjs/).**

#### Only compile CSS and JavaScript - `grunt dist`
`grunt dist` creates the `/dist` directory with compiled files. **Uses [Less](https://lesscss.org/) and [UglifyJS](https://lisperator.net/uglifyjs/).**

#### Tests - `grunt test`
Runs [JSHint](https://jshint.com) and [QUnit](https://qunitjs.com/) tests headlessly in [PhantomJS](https://phantomjs.org/) (used for CI).
